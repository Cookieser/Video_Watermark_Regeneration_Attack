...
# def main(prompt, image_path, output_dir):
...
#     print(f"Finish: {os.path.join(output_dir, fname)}")


# if __name__ == "__main__":
#     parser = argparse.ArgumentParser(description="Generate a single image using StableDiffusion + ControlNet (depth).")
#     parser.add_argument("--prompt", type=str, required=True, help="Text prompt to guide generation.")
#     parser.add_argument("--image", type=str, required=True, help="Path to a single input image.")
#     parser.add_argument("--output_dir", type=str, required=True, help="Directory to save the output image.")
#     args = parser.parse_args()

#     main(args.prompt, args.image, args.output_dir)
